  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8 space-y-6">
      <SEO
        ...
        description="Политика конфиденциальности NexaTrade — B2B-платформы для оптовых закупок и продаж."
      />
      ...
      <p className="text-muted-foreground">
        ...
        обрабатываются и хранятся при использовании платформы NexaTrade.
      </p>

      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-foreground">1. Общие положения</h2>
        <p className="text-muted-foreground">
          Используя NexaTrade, вы предоставляете согласие на обработку ваших персональных данных
